...
public enum Level {
    ...
    LEVEL_5(false, 5, new int[] {0, 4, 3, 0, 0, 0, 0, 0}, null),
    LEVEL_6(false, 6, new int[] {0, 2, 3, 2, 0, 0, 0, 0}, null),
    LEVEL_7(false, 7, new int[] {0, 2, 3, 2, 0, 0, 0, 0}, null),
    LEVEL_8(false, 8, new int[] {0, 1, 2, 4, 0, 0, 0, 0}, null),
    LEVEL_9(false, 9, new int[] {0, 1, 1, 4, 1, 0, 0, 0}, null),
    LEVEL_10(false, 10, new int[] {0, 1, 1, 1, 3, 1, 0, 0}, null),
    LEVEL_11(false, 11, new int[] {0, 1, 2, 3, 1, 1, 0, 0}, null),
    LEVEL_12(false, 12, new int[] {0, 1, 1, 1, 4, 1, 0, 0}, null),
    LEVEL_13(false, 13, new int[] {0, 0, 3, 3, 3, 0, 0, 0}, null),
    LEVEL_14(false, 14, new int[] {0, 0, 0, 0, 0, 7, 1, 0}, null),
    LEVEL_15(false, 15, new int[] {0, 0, 1, 3, 3, 0, 1, 0}, null),
    LEVEL_16(false, 16, new int[] {0, 0, 0, 3, 4, 0, 1, 0}, null),
    LEVEL_17(false, 17, new int[] {0, 0, 5, 0, 2, 0, 1, 0}, null),
    LEVEL_18(false, 18, new int[] {3, 3, 0, 0, 0, 0, 2, 0}, null),
    LEVEL_19(false, 19, new int[] {1, 1, 3, 0, 0, 1, 2, 0}, null),
    LEVEL_20(false, 20, new int[] {0, 1, 1, 1, 2, 1, 2, 0}, null),
    LEVEL_21(false, 21, new int[] {0, 0, 0, 0, 4, 3, 2, 0}, null),
    LEVEL_22(false, 22, new int[] {0, 0, 4, 3, 1, 0, 1, 0}, null),
    LEVEL_23(false, 23, new int[] {0, 0, 2, 2, 2, 2, 1, 0}, null),
    LEVEL_24(false, 24, new int[] {0, 0, 1, 1, 4, 2, 1, 0}, null),
    LEVEL_25(false, 25, new int[] {0, 2, 1, 1, 2, 2, 1, 0}, null),
    LEVEL_26(false, 26, new int[] {1, 1, 1, 1, 2, 1, 1, 0}, null),
    LEVEL_27(false, 27, new int[] {1, 1, 0, 0, 5, 1, 1, 0}, null),
    LEVEL_28(false, 28, new int[] {0, 1, 3, 3, 1, 0, 1, 0}, null),
    LEVEL_29(false, 29, new int[] {0, 0, 0, 0, 2, 5, 2, 0}, null),
    LEVEL_30(false, 30, new int[] {0, 0, 3, 2, 1, 2, 1, 0}, null),
    LEVEL_31(false, 31, new int[] {0, 2, 2, 2, 2, 2, 0, 0}, null),
    LEVEL_32(false, 32, new int[] {0, 1, 1, 3, 4, 0, 1, 0}, null),
    LEVEL_33(false, 33, new int[] {0, 0, 2, 2, 3, 1, 2, 0}, null),
    LEVEL_34(false, 34, new int[] {0, 0, 2, 3, 3, 0, 2, 0}, null),
    LEVEL_35(false, 35, new int[] {0, 0, 2, 1, 3, 1, 2, 0}, null),
    LEVEL_36(false, 36, new int[] {0, 0, 2, 2, 3, 0, 3, 0}, null),
    LEVEL_37(false, 37, new int[] {0, 0, 2, 1, 3, 1, 3, 0}, null),
    LEVEL_38(false, 38, new int[] {0, 0, 2, 2, 3, 0, 3, 0}, null),
    LEVEL_39(false, 39, new int[] {0, 0, 1, 1, 2, 2, 4, 0}, null),
    LEVEL_40(false, 40, new int[] {0, 0, 1, 2, 3, 0, 4, 0}, null),
    LEVEL_41(false, 41, new int[] {0, 0, 1, 1, 3, 1, 4, 0}, null),
    LEVEL_42(false, 42, new int[] {0, 0, 0, 1, 3, 1, 5, 0}, null),
    LEVEL_43(false, 43, new int[] {0, 0, 0, 1, 2, 1, 6, 0}, null),
    LEVEL_44(false, 44, new int[] {0, 0, 0, 1, 2, 1, 6, 0}, null),
    LEVEL_45(false, 45, new int[] {0, 0, 0, 0, 2, 2, 6, 0}, null),
    LEVEL_46(false, 46, new int[] {0, 0, 0, 0, 2, 2, 6, 0}, null),
    LEVEL_47(false, 47, new int[] {0, 0, 0, 0, 2, 2, 6, 0}, null),
    LEVEL_48(false, 48, new int[] {0, 0, 0, 0, 2, 1, 6, 1}, null),
    LEVEL_49(false, 49, new int[] {0, 0, 0, 0, 1, 2, 6, 1}, null),
    LEVEL_50(false, 50, new int[] {0, 0, 0, 0, 1, 2, 5, 2}, null),
